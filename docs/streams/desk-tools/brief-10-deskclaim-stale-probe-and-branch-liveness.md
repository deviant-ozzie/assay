...
| 9 | `go test ./cmd/deskclaim/... ./internal/deskkit/... ./internal/loopengine/... -skip '^(TestRegistryCoversCmdBinaries\|TestReStampRecovery)' -count=1` | 0 | Re-scoped to the brief's own + consumer packages, excluding #555's two unrelated deskkit reds: `./cmd/deskclaim/...` ok, `./internal/deskkit/...` ok, `./internal/loopengine/...` ok (re-run on current main 2026-09-06). CI runs the whole suite on the PR. |
