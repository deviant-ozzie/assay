...
fragment, while a documentation-only or Evidence-only PR carries the waiver label, applied at create by
the PR-opening desk verb rather than chased down after the check has already gone red. This paragraph
